...
jQuery(document).ready(function($) {
    ...
    $('#voice-stop-btn').on('click', function() {
    ...
    function initVoiceRecognition() {
        ...
        recognition.onerror = function(event) {
            ...
            stopVoiceRecognition();
            addMessageToChat("Sorry, I couldn't hear you clearly. Please try again! 🎤", false);
        };
    ...
    function startVoiceRecognition() {
        if (recognition && !isListening) {
            try {
                ...
                addMessageToChat("Voice recognition is not available right now. Please try again later. 🎤", false);
            }
        }
    }
    ...
    function handleResponse(response) {
        ...
        switch (data.type) {
            case 'conversation':
                ...
                // If this is a voice response, speak it
                if (isListening) {
